...
form.addEventListener('submit', function (event) { return __awaiter(_this, void 0, void 0, function () {
    var name, email, contactNumber, subject, message, apiUrl, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                apiUrl = 'https://6717faf8b910c6a6e02ac448.mockapi.io/Contacts';
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Error Occur During Submission:', error_1);
